...
public class ClipVideoRecorder implements Cloneable
{
	public int width = -1;
	public int height = -1;
	...
	public int secondToTakeThumbFrom = -1;
	public boolean fast264 = false;
	public int cropValue = -1;
	public int cropValueBigger = -1;
		
	public ClipVideoRecorder ()
	{
		
	}
	
	public ClipVideoRecorder (String path)
	{
		this.path = path;
	}
	...
	public void setCropValue(int cropValue) {
